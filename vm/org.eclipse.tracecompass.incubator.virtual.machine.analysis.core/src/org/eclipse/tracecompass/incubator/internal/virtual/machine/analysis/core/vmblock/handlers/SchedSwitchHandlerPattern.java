 ...
 * @author Hani Nemati
 */
public class SchedSwitchHandlerPattern extends VMblockAnalysisEventHandler {
     ...
     *            The state provider
     */
    public SchedSwitchHandlerPattern(IKernelAnalysisEventLayout layout, VMblockAnalysisStateProvider sp) {
        super(layout, sp);
    }
