 ...
 * @author Hani Nemati
 */
public class SysEntryHandlerPattern extends VMblockAnalysisEventHandler {
     ...
     *            The state provider
     */
    public SysEntryHandlerPattern(IKernelAnalysisEventLayout layout, VMblockAnalysisStateProvider sp) {
        super(layout, sp);
    }
