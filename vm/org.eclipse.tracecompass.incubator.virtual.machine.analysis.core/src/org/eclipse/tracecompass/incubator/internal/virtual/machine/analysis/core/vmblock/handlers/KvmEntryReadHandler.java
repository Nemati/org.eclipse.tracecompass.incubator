 ...
 * @author Hani Nemati
 */
public class KvmEntryReadHandler extends VMblockAnalysisEventHandler {

    public KvmEntryReadHandler(IKernelAnalysisEventLayout layout, VMblockAnalysisStateProvider sp) {
    ...
    public void handleEvent(ITmfStateSystemBuilder ss, ITmfEvent event) {
        ...
        if (KvmEntryHandler.pid2VM.containsKey(pid.intValue())) {
            KvmEntryHandler.pid2VM.get(pid.intValue()).setRead2Time(tid.intValue(), ts);
        }
