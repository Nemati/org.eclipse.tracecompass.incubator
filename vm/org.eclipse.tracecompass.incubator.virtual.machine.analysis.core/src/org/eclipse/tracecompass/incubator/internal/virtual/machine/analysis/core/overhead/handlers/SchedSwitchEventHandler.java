...
public class SchedSwitchEventHandler implements IVirtualMachineEventHandler {
     ...
     */
    private static void handleHostSchedSwitch(ITmfStateSystemBuilder ss, ITmfEvent event, IVirtualEnvironmentModel virtEnv, IKernelAnalysisEventLayout eventLayout) {
    ...
    /**
     * Update the guest thread status
     *
     * @param event
     *            The current event
     */
    public void update(ITmfEvent event) {
