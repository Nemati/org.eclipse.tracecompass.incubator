 ...
 * @author Hani Nemati
 */
public class SysExitHandlerPattern extends VMblockAnalysisEventHandler {
     ...
     *            The state provider
     */
    public SysExitHandlerPattern(IKernelAnalysisEventLayout layout, VMblockAnalysisStateProvider sp) {
        super(layout, sp);
    }
